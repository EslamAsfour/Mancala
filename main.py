...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.NewGameBtn = QtWidgets.QPushButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.NewGameBtn.sizePolicy().hasHeightForWidth())
        self.NewGameBtn.setSizePolicy(sizePolicy)
        self.NewGameBtn.setMaximumSize(QtCore.QSize(446, 16777215))
        font = QtGui.QFont()
        font.setFamily("Simplified Arabic")
        font.setPointSize(20)
        font.setItalic(False)
        self.NewGameBtn.setFont(font)
        self.NewGameBtn.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.NewGameBtn.setStyleSheet("border-radius: 25px;background-color: rgb(255, 252, 168);margin-left : 50px;")
        ...
        self.ExitGameBtn = QtWidgets.QPushButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.NewGameBtn.clicked.connect(self.StartGame)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.NewGameBtn.setText(_translate("MainWindow", "New Game"))
